...
%           dvips,                                      % auskommentieren, falls pdflatex verwendet wird
            pdftitle=Europäische Identität,             % Titel des PDF Dokuments
            pdfauthor=Swen Mayer,                       % Author des PDF Dokuments
            hypertexnames=true,
            breaklinks=true,
            colorlinks=true,
            linkcolor=darkblue,
...
\begin{titlepage}
\begin{center}
\begin{large}Friedrich-Schiller-Universität Jena\end{large}\vspace{0,25cm}\linebreak  
Fakultät für Sozial- und Verhaltenswissenschaften\linebreak\medskip 
Institut für Politikwissenschaft\linebreak\vspace*{2cm}

\textbf{\begin{LARGE}Hausarbeit\end{LARGE}}\vspace*{2.5cm}\linebreak
...
\begin{large} eingereicht bei: Florian Weber, M.A.\vspace{0,25cm} \\ \end{large}
\begin{large} eingereicht von: Swen Mayer \vspace{0,25cm}\\ Wintersemester 2011/12\vspace{0,25cm}\\ Seminar: Seminartitel
\end{large}
%\linebreak
%\end{center}

\begin{large}
\vfill {11. Fachsemester/ Magister \\  Matrikelnummer: 85489 \\HF Politikwissenschaft \\NF Neurere Geschichte \\NF Volkskunde/ Kulturgeschichte\\ }
\end{large}

\begin{small}
\vfill {Swen Mayer \\ Am Eichwald 8a \\  07422 Bad Blankenburg \\  Swen.Mayer(at)uni-jena.de \\ Abgabedatum 2012\\ }
...
\\
\\
Jena, den Abgabedatum\\
\\
\\
\rule{60mm}{0,2mm} \\
\hspace{50mm}Swen Mayer
\clearpage
\end{document}
%-------------------
