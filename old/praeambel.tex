...
\usepackage[latin1,ansinew]{inputenc} %serifenlose Schrift

\usepackage{helvet} %Helvetica clone
\renewcommand{\familydefault}{\sfdefault} 

\usepackage{ngerman} %\usepackage[french]{babel}
\usepackage{setspace} %Das Paket wird für die anderthalb-zeiligen Zeilenabstand benötigt
...
\usepackage{url}
\usepackage{color}
\usepackage[automark, plainheadsepline, nouppercase]{scrpage2} 
